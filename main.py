...
# -----------------------------------------------------------------------------
# 4. 원본 데이터 요약 통계 섹션 (개수·표준편차 포함 & 가로/세로 전환 적용)
# -----------------------------------------------------------------------------
